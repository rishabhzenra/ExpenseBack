    ...
    async seedAll(userId) {
        ...
        for (let m = 5; m >= 0; m--) {
            ...
            const entries = [
                ...
                { amount: 2000, category: expense_category_enum_1.ExpenseCategory.FUN, merchant: 'BookMyShow', notes: 'Team outing', isRecurring: false, isTaxDeductible: false },
                { amount: 6000, category: expense_category_enum_1.ExpenseCategory.BILLS, merchant: 'Jio Fiber', notes: 'Internet & phone', isRecurring: true, isTaxDeductible: true },
                { amount: 9800, category: expense_category_enum_1.ExpenseCategory.SHOPPING, merchant: 'Dell Technologies', notes: 'Peripherals', isRecurring: false, isTaxDeductible: true },
        ...
        for (let m = 5; m >= 0; m--) {
            const month = new Date(today.getFullYear(), today.getMonth() - m, 1);
            const entries = [
                { amount: 180000, category: income_category_enum_1.IncomeCategory.SALARY, source: 'Savora Technologies Pvt Ltd', notes: 'Monthly CTC', isRecurring: true },
                ...
                { amount: 12000, category: income_category_enum_1.IncomeCategory.INVESTMENT, source: 'Zerodha Portfolio', notes: 'Equity dividend', isRecurring: false },
        ...
        await this.subRepo.save(this.subRepo.create([
            { userId, name: 'AWS', description: 'Cloud infrastructure', amount: 12000, billingCycle: subscription_entity_1.BillingCycle.MONTHLY, status: subscription_entity_1.SubscriptionStatus.ACTIVE, category: 'Infrastructure', nextBillingDate: this.nextMonth(), startDate: '2024-01-01' },
            { userId, name: 'GitHub Teams', description: 'Code collaboration', amount: 4200, billingCycle: subscription_entity_1.BillingCycle.MONTHLY, status: subscription_entity_1.SubscriptionStatus.ACTIVE, category: 'Development', nextBillingDate: this.nextMonth(), startDate: '2023-06-01' },
            { userId, name: 'Figma Professional', description: 'Design tool', amount: 3600, billingCycle: subscription_entity_1.BillingCycle.MONTHLY, status: subscription_entity_1.SubscriptionStatus.ACTIVE, category: 'Design', nextBillingDate: this.nextMonth(), startDate: '2023-08-01' },
            { userId, name: 'Notion Team', description: 'Project management', amount: 2400, billingCycle: subscription_entity_1.BillingCycle.MONTHLY, status: subscription_entity_1.SubscriptionStatus.ACTIVE, category: 'Productivity', nextBillingDate: this.nextMonth(), startDate: '2024-02-01' },
            ...
            { userId, name: 'Adobe Creative Cloud', description: 'Design suite', amount: 54000, billingCycle: subscription_entity_1.BillingCycle.YEARLY, status: subscription_entity_1.SubscriptionStatus.ACTIVE, category: 'Design', nextBillingDate: '2025-11-01', startDate: '2024-11-01' },
            ...
            { userId, name: 'Linear', description: 'Issue tracking', amount: 3000, billingCycle: subscription_entity_1.BillingCycle.MONTHLY, status: subscription_entity_1.SubscriptionStatus.ACTIVE, category: 'Development', nextBillingDate: this.nextMonth(), startDate: '2024-03-01', isTrial: false },
        ]));
        const clients = await this.clientRepo.save(this.clientRepo.create([
            { userId, name: 'Arjun Mehta', email: 'arjun.mehta@techcorp.in', phone: '+91 98765 43210', company: 'TechCorp Global Pvt Ltd', address: 'Bandra Kurla Complex, Mumbai 400051', industry: 'Technology', status: client_entity_1.ClientStatus.ACTIVE, totalBilled: 480000, totalPaid: 420000, notes: 'Long-term retainer client. Requires weekly check-ins.' },
            { userId, name: 'Priya Sharma', email: 'priya.s@nexus.co', phone: '+91 87654 32109', company: 'Nexus Innovations', address: 'Koramangala, Bangalore 560034', industry: 'SaaS', status: client_entity_1.ClientStatus.ACTIVE, totalBilled: 320000, totalPaid: 320000, notes: 'Full payment always on time. Excellent relationship.' },
            { userId, name: 'Rohit Bansal', email: 'rohit@greenleaf.org', phone: '+91 76543 21098', company: 'GreenLeaf Ventures', address: 'Cyber City, Gurugram 122002', industry: 'Finance', status: client_entity_1.ClientStatus.ACTIVE, totalBilled: 195000, totalPaid: 130000, notes: 'Partial payment. Follow up on remaining 65,000.' },
            { userId, name: 'Ananya Iyer', email: 'a.iyer@healthplus.com', phone: '+91 65432 10987', company: 'HealthPlus Systems', address: 'Jubilee Hills, Hyderabad 500033', industry: 'Healthcare', status: client_entity_1.ClientStatus.INACTIVE, totalBilled: 85000, totalPaid: 85000, notes: 'Project completed. May return for maintenance.' },
            { userId, name: 'Vikram Singh', email: 'vikram@retailone.in', phone: '+91 54321 09876', company: 'RetailOne Corp', address: 'Connaught Place, New Delhi 110001', industry: 'Retail', status: client_entity_1.ClientStatus.PROSPECT, totalBilled: 0, totalPaid: 0, notes: 'In negotiation. Proposal sent for ₹2L project.' },
        ]));
        ...
        await this.invRepo.save(this.invRepo.create([
            {
                ...
                clientAddress: 'Bandra Kurla Complex, Mumbai', status: invoice_entity_1.InvoiceStatus.PAID, issueDate: '2025-01-15', dueDate: '2025-02-15', paidDate: '2025-02-10',
            ...
            },
            {
                ...
                clientAddress: 'Koramangala, Bangalore', status: invoice_entity_1.InvoiceStatus.PAID, issueDate: '2025-02-01', dueDate: '2025-03-01', paidDate: '2025-02-28',
            ...
            },
            {
                ...
                clientAddress: 'Bandra Kurla Complex, Mumbai', status: invoice_entity_1.InvoiceStatus.SENT, issueDate: '2025-03-01', dueDate: '2025-04-01',
            ...
            },
            {
                ...
                clientAddress: 'Jubilee Hills, Hyderabad', status: invoice_entity_1.InvoiceStatus.DRAFT, issueDate: '2025-03-20', dueDate: '2025-04-20',
        ...
        await this.taxRepo.save(this.taxRepo.create([
            { userId, title: 'Advance Tax – Q4 FY 2024-25', category: tax_entry_entity_1.TaxCategory.ADVANCE_TAX, status: tax_entry_entity_1.TaxStatus.PAID, amount: 42000, dueDate: '2025-03-15', paidDate: '2025-03-12', financialYear: 'FY 2024-25', referenceNumber: 'ADV-2025-001', notes: 'Paid via NSDL portal' },
            { userId, title: 'GST Return – February 2025', category: tax_entry_entity_1.TaxCategory.GST, status: tax_entry_entity_1.TaxStatus.FILED, amount: 68400, dueDate: '2025-03-20', paidDate: '2025-03-18', financialYear: 'FY 2024-25', referenceNumber: 'GSTR1-FEB25', notes: 'GSTR-1 & GSTR-3B filed' },
            { userId, title: 'TDS on Professional Fees', category: tax_entry_entity_1.TaxCategory.TDS, status: tax_entry_entity_1.TaxStatus.PAID, amount: 15000, dueDate: '2025-03-07', paidDate: '2025-03-05', financialYear: 'FY 2024-25', referenceNumber: 'TDS-Q3-2425', notes: 'TDS deducted by TechCorp Global' },
            { userId, title: 'Income Tax – Self Assessment', category: tax_entry_entity_1.TaxCategory.INCOME_TAX, status: tax_entry_entity_1.TaxStatus.PENDING, amount: 95000, dueDate: '2025-07-31', financialYear: 'FY 2024-25', referenceNumber: '', notes: 'Consult CA before filing' },
            { userId, title: 'GST Return – March 2025', category: tax_entry_entity_1.TaxCategory.GST, status: tax_entry_entity_1.TaxStatus.PENDING, amount: 72000, dueDate: '2025-04-20', financialYear: 'FY 2024-25', referenceNumber: '', notes: 'Prepare GSTR-1 data from invoices' },
            { userId, title: 'Property Tax – FY 2024-25', category: tax_entry_entity_1.TaxCategory.PROPERTY_TAX, status: tax_entry_entity_1.TaxStatus.OVERDUE, amount: 18500, dueDate: '2025-03-31', financialYear: 'FY 2024-25', referenceNumber: '', notes: 'Municipal corporation – late fee may apply' },
        ]));
        await this.invstRepo.save(this.invstRepo.create([
            { userId, name: 'Reliance Industries', type: investment_entity_1.InvestmentType.STOCKS, investedAmount: 150000, currentValue: 198500, platform: 'Zerodha', ticker: 'RELIANCE', purchaseDate: '2023-06-15', notes: 'Long-term hold' },
            { userId, name: 'HDFC Flexi Cap Fund', type: investment_entity_1.InvestmentType.MUTUAL_FUND, investedAmount: 240000, currentValue: 298000, platform: 'Groww', ticker: 'HDFCFLEXICAP', purchaseDate: '2022-10-01', notes: 'SIP ₹10,000/month' },
            { userId, name: 'Infosys Ltd', type: investment_entity_1.InvestmentType.STOCKS, investedAmount: 85000, currentValue: 79200, platform: 'Zerodha', ticker: 'INFY', purchaseDate: '2024-01-10', notes: 'IT sector bet' },
            { userId, name: 'Bitcoin', type: investment_entity_1.InvestmentType.CRYPTO, investedAmount: 100000, currentValue: 143000, platform: 'CoinDCX', ticker: 'BTC', purchaseDate: '2023-11-20', notes: 'High risk allocation' },
            { userId, name: 'SBI Fixed Deposit', type: investment_entity_1.InvestmentType.FIXED_DEPOSIT, investedAmount: 500000, currentValue: 534500, platform: 'SBI', ticker: null, purchaseDate: '2024-03-01', notes: '6.8% p.a. for 1 year' },
            { userId, name: 'Sovereign Gold Bond', type: investment_entity_1.InvestmentType.GOLD, investedAmount: 75000, currentValue: 89000, platform: 'HDFC Bank', ticker: 'SGB', purchaseDate: '2023-04-10', notes: '2.5% annual interest + gold returns' },
            { userId, name: 'Mirae Asset Large Cap', type: investment_entity_1.InvestmentType.MUTUAL_FUND, investedAmount: 180000, currentValue: 214000, platform: 'Kuvera', ticker: 'MIRAELARGE', purchaseDate: '2022-07-01', notes: 'Core portfolio' },
            { userId, name: 'PPF Account', type: investment_entity_1.InvestmentType.PPF, investedAmount: 150000, currentValue: 163500, platform: 'Post Office', ticker: null, purchaseDate: '2023-04-01', notes: '7.1% p.a. tax-free' },
        ]));
